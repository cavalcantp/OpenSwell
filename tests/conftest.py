...
def client(
    ...
    app.dependency_overrides[get_geocode_service] = lambda: geocoding_service
    app.dependency_overrides[get_surf_recommender_llm] = lambda: surf_recommender_llm
    app.dependency_overrides[get_surf_recommender_service] = lambda: surf_recommender_service
